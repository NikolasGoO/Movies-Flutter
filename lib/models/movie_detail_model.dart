...
import 'package:movies/models/spoken_languange_model.dart';
  ...
  MovieDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    if(json['production_companies'] != null) {
      ...
      json['production_companies'].forEach((v) {
        productionCompanies!.add(new ProductionCompanyModel.fromJson(v)); // Converte a lista de ProductionCompanyModel para JSON.
      });
    }
